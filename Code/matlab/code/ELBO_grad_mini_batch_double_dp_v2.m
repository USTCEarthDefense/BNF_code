...
function [df, model] =  ELBO_grad_mini_batch_double_dp_v2(x, data, batch_indices, batch_entries, model)
    %deassemble
    %1) psuedo input
    ...
    for i=1:n_events
        ...
        %one event has potential influence over all the other influence
